...
const Profile = () => {
  return (
    <div className="bg-gray-900 h-full w-full lg:w-2/5 rounded-tl-lg rounded-bl-lg rounded-tr-lg lg:rounded-tr-none relative">
      ...
      <div className="absolute bottom-0 p-5 text-white text-center w-full bg-gray-900">
