...
const Service = () => (
	<div className="text-center mb-10">
		...
		<p className="mb-5">
			Give my best effort for every projects. I give a solution with my creative
			app.
		</p>
		<div className="grid grid-cols-1 lg:grid-cols-2 gap-4 text-center">
			<div className="py-5">
				...
				<p className="text-sm text-gray-500">
					I am ready to start from scratch, or continue the ongoing projects. I
					always give innovative ideas to build the best applications.
				</p>
			</div>
			<div className="py-5">
				<Image
				...
				<p className="text-sm text-gray-500">
					I always give a clean code to the client so the application is easy to
					understand and easy to develop.
				</p>
			</div>
			<div className="py-5">
				<Image
				...
				<p className="text-sm text-gray-500">
					I always communicate with the client so simply the application is
					really fit with what client needs.
				</p>
			</div>
			<div className="py-5">
				<Image
